...
class TranslateController extends GetxController {
  ...
  Future<void> translate() async {
    if (textC.text.trim().isNotEmpty && to.isNotEmpty) {
      ...
      final res = await APIs.getTextAnswer(prompt);
      resultC.text = res;
      status.value = Status.complete;
    } else {
      status.value = Status.none;
      if (to.isEmpty) CustomDialog.info('Select To Language!');
      if (textC.text.isEmpty) CustomDialog.info('Type Smething to Translate!');
    }
  }
